...
<el-button class="btn-1" type="warning" icon="el-icon-star-off" @click="compute_sentence()" style="margin-top: 10px; margin-bottom: 10px;margin-left: 48%;">查询</el-button>
<el-table
    :data="tableData"
    height="200"
    border
